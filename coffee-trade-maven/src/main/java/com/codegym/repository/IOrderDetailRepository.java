...
public interface IOrderDetailRepository extends JpaRepository<OrderDetail, Long> {
    ...
    @Query("SELECT NEW com.codegym.model.dto.OrderDetailDTO (o.id, o.quantity, o.drinks.id, o.order.id,o.drinks.price,o.amount) FROM OrderDetail o WHERE o.isDeleted = false ")
